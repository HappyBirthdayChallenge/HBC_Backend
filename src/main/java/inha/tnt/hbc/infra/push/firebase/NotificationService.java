...
public class NotificationService {
	...
	public void sendNotification(Long memberId, String content) {
		fcmTokenService.getFcmTokens(memberId)
			.forEach(token -> sendNotification(token, memberId, generateMessage(token, content)));
	}

	@Async
	public void sendNotifications(List<Long> memberIds, String content) {
		memberIds.forEach(memberId -> sendNotification(memberId, content));
	}
